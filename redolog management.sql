...
#ADDING MEMBER IN LOGFILE group
...
alter database add logfile group 4 ('/u01/duplex/redo_4_03.log','/reco/VAMDB/onlinelog/redo_4_02.log','/database/VAMDB/onlinelog/redo_4_01.log') size 200M;
